...
map.getView().fit([5809841.483997645,	7555408.090494358, 6632891.193370545,	8805774.80473355], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Слои:</h2>';
        return titleElement;
    })(),
