...
lyr_ESRIGraylight_0.setVisible(true);lyr_C_1.setVisible(false);lyr_T_2.setVisible(false);lyr_P_3.setVisible(true);
var layersList = [lyr_ESRIGraylight_0,lyr_C_1,lyr_T_2,lyr_P_3];
lyr_T_2.set('fieldAliases', {'name': 'Район', 'Co': 'Co, мг/кг', 'Cu': 'Cu, мг/кг', 'Zn': 'Zn, мг/кг', });
lyr_P_3.set('fieldAliases', {'name': 'Район', 'area': 'Площадь, га', 'plow': 'Обрабатывается земель, га', });
